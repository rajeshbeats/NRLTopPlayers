...
struct Endpoint {
	...
	private static let topPlayers = "https://statsapi.foxsports.com.au/3.0/api/sports/league/matches/%d/topplayerstats.json;type=fantasy_points;type=tackles;type=runs;type=run_metres?limit=5&userkey=%@"
